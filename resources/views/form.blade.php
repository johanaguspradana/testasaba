            ...
            <div class="modal-body">
                <form id="tambah">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="inputGula" name="gula" required>
                    </div>
                    <div class="form-group">
                        <label for="inputTepung">Tepung Tapioka</label>
                        <input type="text" class="form-control" id="inputTepung" name="tepung" required>
                    </div>
                    <div class="form-group">
                        <label for="inputCoklat">Coklat Padat</label>
                        <input type="text" class="form-control" id="inputCoklat" name="coklat" required>
                    </div>
